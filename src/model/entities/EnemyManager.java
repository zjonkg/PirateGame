...
import static model.utils.Constants.EnemyConstants.*;
...
//				c.drawAttackBox(g, xLvlOffset);
    ...
    public void checkExplosionDamage(Rectangle2D.Float explosionArea) {
        for (Crabby c : crabbies) {
            if (c.isActive() && explosionArea.intersects(c.getHitbox())) {
                c.hurt(10);
                return;
            }
        }
