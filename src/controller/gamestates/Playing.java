...
import view.ui.LevelCompletedOverlay;
    ...
    if (!gameOver) {
        if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            if (player.isRight()) {
                ...
                xSpeed = player.isLastDirectionRight() ? 3f : -3f; // Usa la última dirección si está en idle
            }

            float ySpeed = -2.10f * Game.SCALE; 
            player.throwBomb(xSpeed, ySpeed);
        }
    }
}
